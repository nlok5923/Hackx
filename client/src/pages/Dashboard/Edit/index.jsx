...
const Edit = () => {
  ...
  const [quizDateAndTimeAndTitleAndBatch, setQuizDateAndTimeAndTitleAndBatch] =
    useState({ date: "", time: "", title: "", batch: "" });
  ...
  const showPreviousQuestion = () =>
    previousQuestion.map((ele, index) => (
      <Form.Field>
        ...
        <HamburgerMenu>
          <Container>
            ...
            <Form>
              ...
              <input
                style={buttonStyle}
                value={quizDateAndTimeAndTitleAndBatch.title}
                name="title"
              ...
              <Dropdown
                style={buttonStyle}
                floated="right"
                value={quizDateAndTimeAndTitleAndBatch.batch}
                clearable
                options={batches}
                name="batch"
                selection
              ...
              <input
                style={buttonStyle}
                value={quizDateAndTimeAndTitleAndBatch.date}
                name="date"
                onChange={(e) => setDateAndTimeAndTitle(e)}
                type="date"
              ></input>
              <input
                style={buttonStyle}
                value={quizDateAndTimeAndTitleAndBatch.time}
                name="time"
                onChange={(e) => setDateAndTimeAndTitle(e)}
                type="time"
              ></input>
              <input
                style={buttonStyle}
                value={quizDateAndTimeAndTitleAndBatch.endtime}
                name="endtime"
                onChange={(e) => setDateAndTimeAndTitle(e)}
                type="time"
              ></input>
              <input
                style={buttonStyle}
                value={quizDateAndTimeAndTitleAndBatch.phno}
                name="phno"
                onChange={(e) => setDateAndTimeAndTitle(e)}
                type="text"
              ></input>
